...
SGN_ALPHA_OPT := 0
POW_OPT := 0
OPTMIZATION_FLAGS := -D_POW_OPT_=$(POW_OPT) -D_SGN_ALPHA_OPT_=$(SGN_ALPHA_OPT) -D_MINMAX_NORMALIZE_OPT_=$(MINMAX_NORMALIZE_OPT) -D_MINMAX_OPT_=$(MINMAX_OPT) -D_UPDATE_OPT_=$(UPDATE_OPT) -D_EVALUALTE_SPLIT_OPT_=$(EVALUALTE_SPLIT_OPT) -D_UPDATE_QUANTILES_OPT_=$(UPDATE_QUANTILES_OPT)
